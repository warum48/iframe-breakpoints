...
export default function App() {
  const [breakpoints] = useState([
    ...
    { name: "cosmo", points: [320, 510, 650, 666] },
    { name: "goodhouse", points: [320, 510, 650, 666] },
    { name: "bazaar", points: [320, 510, 650, 666] },
    { name: "graziamagazine", points: [320, 510, 650, 666] },
    { name: "esquire", points: [320, 510, 650, 666] },
    { name: "popmech", points: [320, 510, 650, 666] },
    { name: "mhealth", points: [320, 510, 650, 666] },
    { name: "robb.report", points: [320, 800, 1440] },
  ...
  const [spImplants, setSpImplants] = useState([]);
  ...
  useEffect(() => {
    ...
    aScript.onload = function () {
      ...
      setSpImplants(window.implants);
      setIframeURL(
        //"https://sp.imweb.ru/implant/sp/" +
        //  window.implants[2].name +
        //  "/templates/default/iframe/"
        getImplantURL(window.implants[2].name, window.implants[2].type)
      );
      setImplantName(window.implants[2].name);
      console.log("++++++++++++type", window.implants[2].type);
    };
  }, []);
  ...
  function getImplantURL(name, type) {
    let frameURL =
      "https://sp.imweb.ru/implant/sp/" + name + "/templates/default/iframe/";
    if (type === "vue") {
      frameURL = "https://sp.imweb.ru/implant/sp/" + name + "/";
    }

    return frameURL;
  }

  function setImplantByName(name, type) {
    setImplantName(name);
    ...
    <div className="App">
      ...
      <Container fluid>
        ...
        <Row>
          ...
          <Col xs={12} md={6}>
            <div className="taskname m-1 fw-bold">Or select Sp implant:</div>
            <div className="form-floating">
              <Form.Select
              ...
              <label htmlFor="selectBPShema">Sp implants</label>
            </div>
          </Col>
          <Col xs={12} md={3}>
        ...
        <Row>
          <Col sm={8} className="overflow-scroll">
            <SpIframe
              iframe={`<iframe src=${iframeURL} scrolling="no" style="width: 100%; height: ${
                heightArray[heightArray.length - 1]
